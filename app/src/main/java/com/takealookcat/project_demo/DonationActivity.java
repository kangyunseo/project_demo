...
public class DonationActivity extends AppCompatActivity {
    ...
    List<DonationItem> datas = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new DonationListAdapter(datas, this);
        ...
        btnPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                postValues.put("startDate", "2019-09-20");
                postValues.put("dueDate", "2019-11-30");
                postValues.put("targetAmount", "10000000");
    ...
    ValueEventListener postListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            for( DataSnapshot snapshot : dataSnapshot.getChildren() ) {
                ...
                DonationItem bbs = snapshot.getValue(DonationItem.class); // 컨버팅되서 Bbs로........
                bbs.key = key;
                datas.add(bbs);
